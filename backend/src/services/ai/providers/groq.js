// Groq Provider - Fast and Free AI evaluation
// Uses Llama 3.1 70B for high-quality responses
...
[{"question": "...", "category": "technical|design|behavioral|challenge", "difficulty": "easy|medium|hard"}]`;
    ...
    try {
        ...
        console.error('Groq question generation failed, using mock:', err.message);
...
Return ONLY valid JSON:
{
  ...
  "missedPoints": ["what they should have mentioned"]
    ...
    try {
        ...
        console.error('Groq evaluation failed, using smart fallback:', err.message);
        const mockProvider = require('./mock');
